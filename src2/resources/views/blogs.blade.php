  ...
  <body>
    ...
    <main>
      ...
      <div class="main-wrapper container-fluid">
        ...
        <div class="container-fluid width-90 margin-auto">
          <div class="col-lg-8 col-md-8 col-sm-12 col-sx-12 left-layout">
            <div class="content-box">
              <div class="img">
                <a href="blog-item">
                  <img src="./img/main-blog-1.jpg" alt="" />
                </a>
              </div>
              <div class="content-box-main">
                <div class="title">Ra mắt trailer mới!</div>
                <div class="text">
                  Habitasse platea dictumst vestibulum rhoncus est pellentesque
                  elit ullamcorper massa sapien faucibus et molestie ac feugiat
                  sed. Elementum nibh tellus molestie nunc non blandit massa
                  enim nec. Eget gravida cum sociis natoque penatibus magnis. At
                  quis risus vulputate viverra maecenas.
                </div>
                <div class="bottom">
                  <div class="left">
                    <ul>
                      <li>
                        <img class="avatar" src="./img/avatar-1.png" alt="" />
                        <span>John Doe</span>
                      </li>
                      <li>
            ...
            <div class="content-box">
              <div class="img">
                <a href="">
                  <img src="./img/main-blog-2.jpg" alt="" />
                </a>
              </div>
              <div class="content-box-main">
                <div class="title">Ra mắt trailer mới!</div>
            ...
            <div class="content-box">
              <div class="img">
                <a href="">
                  <img src="./img/main-blog-3.jpg" alt="" />
                </a>
              </div>
              <div class="content-box-main">
                <div class="title">Ra mắt trailer mới!</div>
